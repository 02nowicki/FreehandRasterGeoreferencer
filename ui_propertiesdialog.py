...
# Opis / Description    : setTabStopWidth → setTabStopDistance (usunięte w Qt6)
# =============================================================================
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.horizontalSlider_Transparency.setOrientation(QtCore.Qt.Orientation.Horizontal)
        ...
        if hasattr(self.textEdit_Properties, "setTabStopDistance"):
            self.textEdit_Properties.setTabStopDistance(80)
        else:
