...
# Opis / Description    : Migracja Qt5 → Qt6: enumeracje Qt, QDialog, narzędzia
#                         mapy, focus policy, helper _dialog_accepted_value()
# =============================================================================
...
def _click_focus_policy():
    focus_policy = getattr(Qt, "FocusPolicy", None)
    if focus_policy is not None and hasattr(focus_policy, "ClickFocus"):
        return focus_policy.ClickFocus
    return getattr(Qt, "ClickFocus", 2)
...
class FreehandRasterGeoreferencer(object):
    ...
    def initGui(self):
        ...
        self.spinBoxRotate.setFocusPolicy(_click_focus_policy())
