...
# Opis / Description    : Migracja Qt5 → Qt6: QDialog.accepted (sygnał) →
#                         _dialog_accepted_value(), naprawa metody accept()
# =============================================================================
...
class FreehandRasterGeoreferencerDialog(QDialog, Ui_FreehandRasterGeoreferencer):
    ...
    def accept(self, retValue=None, validate=True):
        if retValue is None:
            retValue = _dialog_accepted_value()
